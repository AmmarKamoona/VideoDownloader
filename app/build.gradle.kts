...
android {
    ...
    defaultConfig {
        applicationId = "com.ytdlp.downloader"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        ndk {
            // Chaquopy supports these ABIs. Keep arm64-v8a for modern phones.
            // Add armeabi-v7a if you want to support older 32-bit devices.
